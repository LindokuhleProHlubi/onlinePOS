...
export const Registration = () => {
 ...
 useEffect(()=> {
      ...
      const fetchPurposes = async()=>{
           ...
           setOpen(!open); 
           let res = await axios.get(baseURL+'bridgeGetPurposes.php');  
           		
           res = dataReceiver(res.data);
...
const fetchNationalID = async()=>{
        ...
        const res = await axios.post(baseURL+'/bridgeGetNationalIDContacts.php', data )
...
const makeEnquiry = async()=>{
        ...
        let data = {purposeID:selectedPurpose,
    ...
    const res = await axios.post(baseURL+'/bridgeSelfEnquiry.php', data )
            .then(function (response) {
            ...
            //  enquiredUserDetailsBag = response.data;
             enquiredUserDetailsBag =  dataReceiver(response.data);


          
           if(enquiredUserDetailsBag.error === '' || enquiredUserDetailsBag.error === undefined){

              if(enquiredUserDetailsBag){
               ...
               }else if(enquiredUserDetailsBag.error !== ''){
              
               alert(enquiredUserDetailsBag.error);
               setOpen(false);
